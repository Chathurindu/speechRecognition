...
function createDownloadLink(blob) {
	...
	add_record.addEventListener("click",function () {
		// console.log(document.getElementById("patient").value)
		  ...
		  var fd=new FormData();
		  fd.append("file",blob, filename);
		  fd.append("patient", document.getElementById("patient").value)
		  fd.append("comment",document.getElementById("cmnt").value)
		  xhr.open("POST","/api/add_record_api",true);
		  xhr.send(fd);

		  window.location.href = "/patient_profile/"+ document.getElementById("patient").value;
	})
